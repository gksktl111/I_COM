...
export function MapView({
  ...
  return (
    ...
    >
      ...
      />
      <div className="pointer-events-none absolute top-4 left-4 flex max-w-[calc(100%-2rem)] items-start gap-2 rounded-lg border bg-white/95 px-4 py-3 text-sm leading-relaxed">
