...
test("admin reads guard before privileged requests, validate filters, and return safe projections", async (t) => {
  ...
  for (const version of ["policy-relevance-2", "policy-relevance-3", "policy-relevance-review-1", "policy-relevance-review-2", "policy-relevance-review-3", "policy-relevance-review-4", "policy-relevance-review-5"]) {
