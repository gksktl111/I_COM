-- A source-bound review v3 can conservatively return our v2 exclusion to pending.
-- The prior exclusion observation remains immutable.
...
begin
  if coalesce(jsonb_typeof(v_assessment),'null')<>'object'
    or coalesce(v_assessment->>'version','') not in ('policy-relevance-1','policy-relevance-2','policy-relevance-3','policy-relevance-review-1','policy-relevance-review-2','policy-relevance-review-3')
  ...
  if v_assessment->>'version' in ('policy-relevance-review-1','policy-relevance-review-2','policy-relevance-review-3') then
  ...
  elsif v_policy.relevance->>'version' in ('policy-relevance-review-1','policy-relevance-review-2','policy-relevance-review-3') then
