...
import { prepareReviewActivation, REVIEW_RELEVANCE_VERSION, REVIEW_DISPOSITION_VERSION, REVIEW_CORRECTION_VERSION } from "../../src/features/policy/server/review-activation.ts";
...
async function main() {
  ...
  if (values["review-version"] !== REVIEW_RELEVANCE_VERSION && values["review-version"] !== REVIEW_DISPOSITION_VERSION && values["review-version"] !== REVIEW_CORRECTION_VERSION)
