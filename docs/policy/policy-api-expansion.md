...
확인일: 2026-09-08 · 아래는 연결 전 조사 기록이다. **이후 인증·목록/상세 실응답·4개 개발 DB 저장·재처리를 완료했다.** 현재 상태와 실행 방법은 [복지로 실행 안내](./policy-bokjiro-runbook.md)를 따른다. 아래의 키·CLI 미준비 설명은 조사 시점 기록이며 현재 상태가 아니다.
